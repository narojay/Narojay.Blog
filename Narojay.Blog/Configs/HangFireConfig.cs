...
namespace Narojay.Blog.Configs
{
    ...
    {
        private static BackgroundJobClient Client { get; } = new();
        ...
        public static void HangFireStart(this IApplicationBuilder app)
        {
            ...
            RecurringJob.AddOrUpdate<IHangfireBackJob>(x => x.StatisticLeaveMessageCount(), "0/10 * * * * ? ",
                TimeZoneInfo.Local, "blog_job"); //每5h检查友链
        }
